    ...
    <div className="bg-slate-50">
          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <h1 className="relative w-fit tracking-tight text-balance mt-16 font-bold !leading-tight text-gray-900 text-5xl md:text-6xl lg:text-7xl">
                Your Image on a{" "}
                <span className="bg-green-600 px-2 text-white mr-2">
                  Custom
                </span>
                Phone Case
              </h1>
              ...
              <div className="mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5">
                <div className="flex -space-x-3">
                  ...
                  />
                  <img
                    className="inline-block object-cover h-10 w-10 rounded-full ring-2 ring-green-600"
                    src="/users/user-5.jpg"
                    alt="user image"
                  />
                </div>
                <div className="flex flex-col justify-between items-center sm:items-start lg:justify-center">
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  design. Had the case for teo and a half months now and{" "}
                  <span className="p-0.5 bg-slate-800 text-white">
                    {" "}
                    the image is super clear
                  </span>
                  , on the case I had before, the image started fading into
                  yellow-ish color after couple of weeks. Love this cover."
                </p>
              </div>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  and that used to lead to scratch marks on my last phone cases.
                  This one still{" "}
                  <span className="p-0.5 bg-slate-800 text-white">
                    {" "}
              ...
              <div className="flex gap-4 mt-2">
                ...
                />
                <div className="flex flex-col">
                  <p className="font-semibold">Danniel</p>
                  <div className="flex gap-1.5 items-center text-zinc-600">
                    <Check className="h-4 w-4 stroke-[3px] text-green-600" />
                    <p className="text-sm"> verfied purchase</p>
                  </div>
      ...
      <section>
        <MaxWidthWrapper className="py-24">
          ...
          <ul className="mx-auto mt-12 max-w-prose am:text-lg space-y-2 w-fit">
            <li className="w-fit">
